...
},{"./modules/form-validate/form":3,"./modules/forms/forms.js":9,"./modules/hero/hero.js":11,"./modules/map/map.js":13,"./modules/nav/nav.js":14,"./modules/sliders/sliders.js":15,"./utils/defer-css.js":16,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
var initForm = function initForm() {
  ...
  var inputs = consultForm.querySelectorAll('[data-input]');
  var inputContainers = consultForm.querySelectorAll('[data-input-container]');
  consultForm.addEventListener('submit', function (evt) {
    evt.preventDefault();
    if (Array.from(inputs).every(function (input, id) {
      return input.value !== '' && !inputContainers[id].classList.contains('is-invalid');
    })) {
      inputs.forEach(function (input) {
        input.value = '';
      });
...
exports.pauseAudio = exports.initAudio = void 0;
var playBtn = document.querySelector('[data-audio-play]');
...
var heroSliderPagination = document.querySelector('.hero__slider-pagination');
var initHero = function initHero() {
  (0, _audio.initAudio)();
  (0, _video.initVideo)();
  heroSliderPagination.addEventListener('click', function (evt) {
    if (evt.target.classList.contains('hero__slider-bullet')) {
      (0, _video.disableVideo)();
      (0, _audio.pauseAudio)();
    }
  });
  var heroOverlays = document.querySelectorAll('.hero__overlay');
  var breakpoints = {
  ...
  setInterval(function () {
    var headerHeight = document.querySelector('[data-header]').clientHeight;
    heroOverlays.forEach(function (overlay) {
      if (breakpoints.mobile.matches) {
        overlay.style.paddingTop = "".concat(headerHeight + 68, "px");
      }
      if (breakpoints.tablet.matches) {
        overlay.style.paddingTop = "".concat(headerHeight + 100, "px");
      }
      if (breakpoints.desktop.matches) {
        overlay.style.paddingTop = "".concat(headerHeight + 80, "px");
      }
    });
  }, 1);
};
...
},{"./audio.js":10,"./video.js":12}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initVideo = exports.disableVideo = void 0;
...
var initMap = function initMap() {
  lazyInit(mapElement, function () {
    ...
    var marker = new L.Marker([55.81656, 37.63772], {
      icon: markerIcon
    });
    marker.addTo(map);
  });
...
var toggleNav = function toggleNav() {
  ...
  var phones = document.querySelectorAll('[data-header-phone]');
...
var initSliders = function initSliders() {
  ...
  var toursSlider = new _swiper.default('.tours__slider', {
    loading: 'lazy',
    watchOverflow: true,
  ...
  var studySlider = new _swiper.default('.study__slider', {
    loading: 'lazy',
    watchOverflow: true,
  ...
  if (window.innerWidth > 1199) {
    var advantagesSlider = new _swiper.default('.advantages__slider', {
      loop: true,
      loading: 'lazy',
...
exports.deferCss = void 0;
var deferCss = function deferCss() {
  var style = document.createElement('link');
  style.rel = 'stylesheet';
  style.href = 'css/style.min.css';
  var goDefer = document.querySelector('link');
  ...
  var goDefer1 = document.querySelector('link');
  goDefer1.parentNode.insertBefore(style1, goDefer1);
};
exports.deferCss = deferCss;
